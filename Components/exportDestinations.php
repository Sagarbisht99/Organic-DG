    ...
    <div class="container py-lg-5">
        ...
        <!-- <div class="row mb-5">
            <div class="col-lg-10 mx-auto">
                <div class="world-map-wrapper p-2" style="background: #1A1A1A; border-bottom: 8px solid #FFCC00;">
                    <img src="assets/global.png" alt="Global Export Map" class="img-fluid w-100 shadow-lg" style="opacity: 0.9; filter: grayscale(20%);">
                </div>
            </div>
        </div> -->
        ...
        <div class="row">
            <div class="col-lg-10 mx-auto">
                <div id="countriesCarousel" class="carousel slide" data-bs-ride="carousel" data-bs-interval="3000">
                    <div class="carousel-indicators">
                        <button type="button" data-bs-target="#countriesCarousel" data-bs-slide-to="0" class="active"></button>
                        <button type="button" data-bs-target="#countriesCarousel" data-bs-slide-to="1"></button>
                        <button type="button" data-bs-target="#countriesCarousel" data-bs-slide-to="2"></button>
                    </div>
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <div class="row g-4">
                                <div class="col-md-4">
                                    <div class="card h-100 border-0 rounded-0 shadow-sm p-4 text-center destination-card">
                                        <div class="mb-3">
                                            <i class="fas fa-flag-usa fa-3x text-gold"></i>
                                        </div>
                                ...
                                <div class="col-md-4">
                                    <div class="card h-100 border-0 rounded-0 shadow-sm p-4 text-center destination-card">
                                        <div class="mb-3">
                                            <i class="fas fa-flag fa-3x text-gold"></i>
                                        </div>
